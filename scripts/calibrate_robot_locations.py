...
some of the sequences we just made it into its own function bc of the complex sequence 
(like calibrate_puck_stack).
"""
...
def calibrate_puck_stack(robot: RobotCommunicator, coord_json, angles_json, clr="red"):
    ...
    steps.append((f"stack-hover-{clr}", "coords", ("angle_table", f"stack-hover-{clr}")))
